            	...
            	<div class="maincontent">          
                    ...
                    while ( have_posts() ) : the_post();
                      ...
                      <li class="<?php echo $cat_slug;?>">
                        <div class="pf-desc-three">
                        <h5><a href="<?php the_permalink();?>"><?php the_title();?></a></h5>
                          <?php the_excerpt();?>
                        </div>
					              <div class="pf-image-three">
                        	<?php if (function_exists('has_post_thumbnail') && has_post_thumbnail()) {?>
                          <a href="<?php echo ($pf_link) ? $pf_link : thumb_url();?>" rel="prettyPhoto"><img src="<?php echo get_template_directory_uri();?>/timthumb.php?src=<?php echo thumb_url();?>&amp;h=209&amp;w=300&amp;zc=1" alt=""/></a>
                          <?php } ?>              
                        </div>
                      </li>
                      <?php endwhile;?>           
