...
//page titles
$titles = array("viewticket"=>"View Ticket", "admin_login"=>"Administrative Login", "user_login"=>"Login", "main"=>"", "pref"=>"Preferences", "mail"=>"Mail Messages", "cat"=>"Categories", "rep"=>"Representatives", "user_group"=>"User Groups", "my"=>"My Account");
